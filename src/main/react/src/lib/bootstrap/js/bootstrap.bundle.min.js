/*!
  ...
  */
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? e(exports, require('jquery')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery'], e) : e((t = t || self).bootstrap = {}, t.jQuery); }(this, (t, p) => {
  function i(t, e) { for (let n = 0; n < e.length; n++) { const i = e[n]; i.enumerable = i.enumerable || !1, i.configurable = !0, 'value' in i && (i.writable = !0), Object.defineProperty(t, i.key, i); } } function s(t, e, n) { return e && i(t.prototype, e), n && i(t, n), t; } function l(o) {
    ...
    function r(t, e) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(e), this._element = t, this._indicatorsElement = this._element.querySelector(it), this._touchSupported = 'ontouchstart' in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent || window.MSPointerEvent), this._addEventListeners(); } const t = r.prototype; return t.next = function () { this._isSliding || this._slide(M); }, t.nextWhenVisible = function () { !document.hidden && p(this._element).is(':visible') && p(this._element).css('visibility') !== 'hidden' && this.next(); }, t.prev = function () { this._isSliding || this._slide(W); }, t.pause = function (t) { t || (this._isPaused = !0), this._element.querySelector(nt) && (m.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null; }, t.cycle = function (t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)); }, t.to = function (t) { const e = this; this._activeElement = this._element.querySelector(Z); const n = this._getItemIndex(this._activeElement); if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding)p(this._element).one(q.SLID, () => e.to(t)); else { if (n === t) return this.pause(), void this.cycle(); const i = n < t ? M : W; this._slide(i, this._items[t]); } }, t.dispose = function () { p(this._element).off(P), p.removeData(this._element, x), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null; }, t._getConfig = function (t) { return t = l({}, R, t), m.typeCheckConfig(L, t, F), t; }, t._handleSwipe = function () { const t = Math.abs(this.touchDeltaX); if (!(t <= 40)) { const e = t / this.touchDeltaX; e > 0 && this.prev(), e < 0 && this.next(); } }, t._addEventListeners = function () { const e = this; this._config.keyboard && p(this._element).on(q.KEYDOWN, (t) => e._keydown(t)), this._config.pause === 'hover' && p(this._element).on(q.MOUSEENTER, (t) => e.pause(t)).on(q.MOUSELEAVE, (t) => e.cycle(t)), this._config.touch && this._addTouchEventListeners(); }, t._addTouchEventListeners = function () { const n = this; if (this._touchSupported) { const e = function (t) { n._pointerEvent && st[t.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = t.originalEvent.clientX : n._pointerEvent || (n.touchStartX = t.originalEvent.touches[0].clientX); }; const i = function (t) { n._pointerEvent && st[t.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = t.originalEvent.clientX - n.touchStartX), n._handleSwipe(), n._config.pause === 'hover' && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout((t) => n.cycle(t), 500 + n._config.interval)); }; p(this._element.querySelectorAll(et)).on(q.DRAG_START, (t) => t.preventDefault()), this._pointerEvent ? (p(this._element).on(q.POINTERDOWN, (t) => e(t)), p(this._element).on(q.POINTERUP, (t) => i(t)), this._element.classList.add($)) : (p(this._element).on(q.TOUCHSTART, (t) => e(t)), p(this._element).on(q.TOUCHMOVE, (t) => { let e; (e = t).originalEvent.touches && e.originalEvent.touches.length > 1 ? n.touchDeltaX = 0 : n.touchDeltaX = e.originalEvent.touches[0].clientX - n.touchStartX; }), p(this._element).on(q.TOUCHEND, (t) => i(t))); } }, t._keydown = function (t) { if (!/input|textarea/i.test(t.target.tagName)) switch (t.which) { case 37: t.preventDefault(), this.prev(); break; case 39: t.preventDefault(), this.next(); } }, t._getItemIndex = function (t) { return this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(tt)) : [], this._items.indexOf(t); }, t._getItemByDirection = function (t, e) { const n = t === M; const i = t === W; const o = this._getItemIndex(e); const r = this._items.length - 1; if ((i && o === 0 || n && o === r) && !this._config.wrap) return e; const s = (o + (t === W ? -1 : 1)) % this._items.length; return s === -1 ? this._items[this._items.length - 1] : this._items[s]; }, t._triggerSlideEvent = function (t, e) {
      ...
      let n; let i; let o; const r = this; const s = this._element.querySelector(Z); const a = this._getItemIndex(s); const l = e || s && this._getItemByDirection(t, s); const c = this._getItemIndex(l); const h = Boolean(this._interval); if (o = t === M ? (n = z, i = X, U) : (n = Y, i = G, B), l && p(l).hasClass(Q)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
        ...
        }); if (p(this._element).hasClass(V)) { p(l).addClass(i), m.reflow(l), p(s).addClass(n), p(l).addClass(n); const f = parseInt(l.getAttribute('data-interval'), 10); this._config.interval = f ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, f) : this._config.defaultInterval || this._config.interval; const d = m.getTransitionDurationFromElement(s); p(s).one(m.TRANSITION_END, () => { p(l).removeClass(`${n} ${i}`).addClass(Q), p(s).removeClass(`${Q} ${i} ${n}`), r._isSliding = !1, setTimeout(() => p(r._element).trigger(u), 0); }).emulateTransitionEnd(d); } else p(s).removeClass(Q), p(l).addClass(Q), this._isSliding = !1, p(this._element).trigger(u); h && this.cycle();
      }
    }, r._jQueryInterface = function (i) { return this.each(function () { let t = p(this).data(x); let e = l({}, R, p(this).data()); typeof i === 'object' && (e = l({}, e, i)); const n = typeof i === 'string' ? i : e.slide; if (t || (t = new r(this, e), p(this).data(x, t)), typeof i === 'number')t.to(i); else if (typeof n === 'string') { if (typeof t[n] === 'undefined') throw new TypeError(`No method named "${n}"`); t[n](); } else e.interval && e.ride && (t.pause(), t.cycle()); }); }, r._dataApiClickHandler = function (t) { const e = m.getSelectorFromElement(this); if (e) { const n = p(e)[0]; if (n && p(n).hasClass(K)) { const i = l({}, p(n).data(), p(this).data()); const o = this.getAttribute('data-slide-to'); o && (i.interval = !1), r._jQueryInterface.call(p(n), i), o && p(n).data(x).to(o), t.preventDefault(); } } }, s(r, null, [{ key: 'VERSION', get() { return '4.3.1'; } }, { key: 'Default', get() { return R; } }]), r;
  ...
  }; const Qt = Object.assign || function (t) { for (let e = 1; e < arguments.length; e++) { const n = arguments[e]; for (const i in n)Object.prototype.hasOwnProperty.call(n, i) && (t[i] = n[i]); } return t; }; function Vt(t) { return { ...t, right: t.left + t.width, bottom: t.top + t.height }; } function Yt(t) {
    ...
    }; const r = t.nodeName === 'HTML' ? Bt(t.ownerDocument) : {}; const s = r.width || t.clientWidth || o.right - o.left; const a = r.height || t.clientHeight || o.bottom - o.top; let l = t.offsetWidth - s; let c = t.offsetHeight - a; if (l || c) { const h = Nt(t); l -= Wt(h, 'x'), c -= Wt(h, 'y'), o.width -= l, o.height -= c; } return Vt(o);
  } function zt(t, e) {
    const n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]; const i = Ht(10); const o = e.nodeName === 'HTML'; const r = Yt(t); const s = Yt(e); const a = Lt(t); const l = Nt(e); const c = parseFloat(l.borderTopWidth, 10); const h = parseFloat(l.borderLeftWidth, 10); n && o && (s.top = Math.max(s.top, 0), s.left = Math.max(s.left, 0)); let u = Vt({
  ...
  } function Xt(t) { if (!t || !t.parentElement || Ht()) return document.documentElement; for (var e = t.parentElement; e && Nt(e, 'transform') === 'none';)e = e.parentElement; return e || document.documentElement; } function Gt(t, e, n, i) {
    const o = arguments.length > 4 && void 0 !== arguments[4] && arguments[4]; let r = { top: 0, left: 0 }; const s = o ? Xt(t) : Ft(t, e); if (i === 'viewport') {
      r = (function (t) {
        const e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]; const n = t.ownerDocument.documentElement; const i = zt(t, n); const o = Math.max(n.clientWidth, window.innerWidth || 0); const r = Math.max(n.clientHeight, window.innerHeight || 0); const s = e ? 0 : Mt(n); const a = e ? 0 : Mt(n, 'left'); return Vt({
          top: s - i.top + i.marginTop, left: a - i.left + i.marginLeft, width: o, height: r,
        });
      }(s, o));
    } else { let a = void 0; i === 'scrollParent' ? (a = Lt(kt(e))).nodeName === 'BODY' && (a = t.ownerDocument.documentElement) : a = i === 'window' ? t.ownerDocument.documentElement : i; const l = zt(a, s, o); if (a.nodeName !== 'HTML' || (function t(e) { const n = e.nodeName; if (n === 'BODY' || n === 'HTML') return !1; if (Nt(e, 'position') === 'fixed') return !0; const i = kt(e); return !!i && t(i); }(s)))r = l; else { const c = Bt(t.ownerDocument); const h = c.height; const u = c.width; r.top += l.top - l.marginTop, r.bottom = h + l.top, r.left += l.left - l.marginLeft, r.right = u + l.left; } } const f = typeof (n = n || 0) === 'number'; return r.left += f ? n : n.left || 0, r.top += f ? n : n.top || 0, r.right -= f ? n : n.right || 0, r.bottom -= f ? n : n.bottom || 0, r;
    ...
    modifiers: {
      ...
      arrow: {
        order: 500, enabled: !0, fn(t, e) { let n; if (!fe(t.instance.modifiers, 'arrow', 'keepTogether')) return t; let i = e.element; if (typeof i === 'string') { if (!(i = t.instance.popper.querySelector(i))) return t; } else if (!t.instance.popper.contains(i)) return console.warn('WARNING: `arrow.element` must be child of its popper element!'), t; const o = t.placement.split('-')[0]; const r = t.offsets; const s = r.popper; const a = r.reference; const l = ['left', 'right'].indexOf(o) !== -1; const c = l ? 'height' : 'width'; const h = l ? 'Top' : 'Left'; const u = h.toLowerCase(); const f = l ? 'left' : 'top'; const d = l ? 'bottom' : 'right'; const p = Zt(i)[c]; a[d] - p < s[u] && (t.offsets.popper[u] -= s[u] - (a[d] - p)), a[u] + p > s[d] && (t.offsets.popper[u] += a[u] + p - s[d]), t.offsets.popper = Vt(t.offsets.popper); const m = a[u] + a[c] / 2 - p / 2; const g = Nt(t.instance.popper); const _ = parseFloat(g[`margin${h}`], 10); const v = parseFloat(g[`border${h}Width`], 10); let y = m - t.offsets.popper[u] - _ - v; return y = Math.max(Math.min(s[c] - p, y), 0), t.arrowElement = i, t.offsets.arrow = (Kt(n = {}, u, Math.round(y)), Kt(n, f, ''), n), t; }, element: '[x-arrow]',
      },
      flip: {
      ...
      inner: { order: 700, enabled: !1, fn(t) { const e = t.placement; const n = e.split('-')[0]; const i = t.offsets; const o = i.popper; const r = i.reference; const s = ['left', 'right'].indexOf(n) !== -1; const a = ['top', 'left'].indexOf(n) === -1; return o[s ? 'left' : 'top'] = r[n] - (a ? o[s ? 'width' : 'height'] : 0), t.placement = te(e), t.offsets.popper = Vt(o), t; } },
      ...
      applyStyle: {
        order: 900, enabled: !0, fn(t) { let e; let n; return he(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, Object.keys(n).forEach((t) => { !1 !== n[t] ? e.setAttribute(t, n[t]) : e.removeAttribute(t); }), t.arrowElement && Object.keys(t.arrowStyles).length && he(t.arrowElement, t.arrowStyles), t; }, onLoad(t, e, n, i, o) { const r = Jt(o, e, t, n.positionFixed); const s = $t(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding); return e.setAttribute('x-placement', s), he(e, { position: n.positionFixed ? 'fixed' : 'absolute' }), n; }, gpuAcceleration: void 0,
      },
    },
  }; const be = (function () {
  ...
  }()); be.Utils = (typeof window !== 'undefined' ? window : global).PopperUtils, be.placements = de, be.Defaults = Ee; const we = 'dropdown'; const Ce = 'bs.dropdown'; const Te = `.${Ce}`; const Se = '.data-api'; const De = p.fn[we]; const Ie = new RegExp('38|40|27'); const Ae = {
  ...
  }; const Oe = 'disabled'; const Ne = 'show'; const ke = 'dropup'; const Le = 'dropright'; const xe = 'dropleft'; const Pe = 'dropdown-menu-right'; const He = 'position-static'; const je = '[data-toggle="dropdown"]'; const Re = '.dropdown form'; const Fe = '.dropdown-menu'; const Me = '.navbar-nav'; const We = '.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)'; const Ue = 'top-start'; const Be = 'top-end'; const qe = 'bottom-start'; const Ke = 'bottom-end'; const Qe = 'right-start'; const Ve = 'left-start'; const Ye = {
  ...
  }; const yn = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi; const En = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i; function bn(t, s, e) { if (t.length === 0) return t; if (e && typeof e === 'function') return e(t); for (var n = (new window.DOMParser()).parseFromString(t, 'text/html'), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll('*')), i = function (t, e) { const n = l[t]; const i = n.nodeName.toLowerCase(); if (a.indexOf(n.nodeName.toLowerCase()) === -1) return n.parentNode.removeChild(n), 'continue'; const o = [].slice.call(n.attributes); const r = [].concat(s['*'] || [], s[i] || []); o.forEach((t) => { (function (t, e) { const n = t.nodeName.toLowerCase(); if (e.indexOf(n) !== -1) return _n.indexOf(n) === -1 || Boolean(t.nodeValue.match(yn) || t.nodeValue.match(En)); for (let i = e.filter((t) => t instanceof RegExp), o = 0, r = i.length; o < r; o++) if (n.match(i[o])) return !0; return !1; }(t, r)) || n.removeAttribute(t.nodeName); }); }, o = 0, r = l.length; o < r; o++)i(o); return n.body.innerHTML; } const wn = 'tooltip'; const Cn = 'bs.tooltip'; const Tn = `.${Cn}`; const Sn = p.fn[wn]; const Dn = 'bs-tooltip'; const In = new RegExp(`(^|\\s)${Dn}\\S+`, 'g'); const An = ['sanitize', 'whiteList', 'sanitizeFn']; const On = {
  ...
  }; const Ln = 'show'; const xn = 'out'; const Pn = {
  ...
  }; const Hn = 'fade'; const jn = 'show'; const Rn = '.tooltip-inner'; const Fn = '.arrow'; const Mn = 'hover'; const Wn = 'focus'; const Un = 'click'; const Bn = 'manual'; const qn = (function () {
  ...
  }); const $n = l({}, qn.DefaultType, { content: '(string|element|function)' }); const Jn = 'fade'; const Zn = 'show'; const ti = '.popover-header'; const ei = '.popover-body'; const ni = {
  ...
  }; const ii = (function (t) { let e; let n; function i() { return t.apply(this, arguments) || this; }n = t, (e = i).prototype = Object.create(n.prototype), (e.prototype.constructor = e).__proto__ = n; const o = i.prototype; return o.isWithContent = function () { return this.getTitle() || this._getContent(); }, o.addAttachmentClass = function (t) { p(this.getTipElement()).addClass(`${zn}-${t}`); }, o.getTipElement = function () { return this.tip = this.tip || p(this.config.template)[0], this.tip; }, o.setContent = function () { const t = p(this.getTipElement()); this.setElementContent(t.find(ti), this.getTitle()); let e = this._getContent(); typeof e === 'function' && (e = e.call(this.element)), this.setElementContent(t.find(ei), e), t.removeClass(`${Jn} ${Zn}`); }, o._getContent = function () { return this.element.getAttribute('data-content') || this.config.content; }, o._cleanTipClass = function () { const t = p(this.getTipElement()); const e = t.attr('class').match(Xn); e !== null && e.length > 0 && t.removeClass(e.join('')); }, i._jQueryInterface = function (n) { return this.each(function () { let t = p(this).data(Qn); const e = typeof n === 'object' ? n : null; if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Qn, t)), typeof n === 'string')) { if (typeof t[n] === 'undefined') throw new TypeError(`No method named "${n}"`); t[n](); } }); }, s(i, null, [{ key: 'VERSION', get() { return '4.3.1'; } }, { key: 'Default', get() { return Gn; } }, { key: 'NAME', get() { return Kn; } }, { key: 'DATA_KEY', get() { return Qn; } }, { key: 'Event', get() { return ni; } }, { key: 'EVENT_KEY', get() { return Vn; } }, { key: 'DefaultType', get() { return $n; } }]), i; }(qn)); p.fn[Kn] = ii._jQueryInterface, p.fn[Kn].Constructor = ii, p.fn[Kn].noConflict = function () { return p.fn[Kn] = Yn, ii._jQueryInterface; }; const oi = 'scrollspy'; const ri = 'bs.scrollspy'; const si = `.${ri}`; const ai = p.fn[oi]; const li = { offset: 10, method: 'auto', target: '' }; const ci = { offset: 'number', method: 'string', target: '(string|element)' }; const hi = { ACTIVATE: `activate${si}`, SCROLL: `scroll${si}`, LOAD_DATA_API: `load${si}.data-api` }; const ui = 'dropdown-item'; const fi = 'active'; const di = '[data-spy="scroll"]'; const pi = '.nav, .list-group'; const mi = '.nav-link'; const gi = '.nav-item'; const _i = '.list-group-item'; const vi = '.dropdown'; const yi = '.dropdown-item'; const Ei = '.dropdown-toggle'; const bi = 'offset'; const wi = 'position'; const Ci = (function () {
    function n(t, e) { const n = this; this._element = t, this._scrollElement = t.tagName === 'BODY' ? window : t, this._config = this._getConfig(e), this._selector = `${this._config.target} ${mi},${this._config.target} ${_i},${this._config.target} ${yi}`, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(hi.SCROLL, (t) => n._process(t)), this.refresh(), this._process(); } const t = n.prototype; return t.refresh = function () {
      const e = this; const t = this._scrollElement === this._scrollElement.window ? bi : wi; const o = this._config.method === 'auto' ? t : this._config.method; const r = o === wi ? this._getScrollTop() : 0; this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map((t) => { let e; const n = m.getSelectorFromElement(t); if (n && (e = document.querySelector(n)), e) { const i = e.getBoundingClientRect(); if (i.width || i.height) return [p(e)[o]().top + r, n]; } return null; }).filter((t) => t).sort((t, e) => t[0] - e[0])
        .forEach((t) => { e._offsets.push(t[0]), e._targets.push(t[1]); });
    }, t.dispose = function () { p.removeData(this._element, ri), p(this._scrollElement).off(si), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null; }, t._getConfig = function (t) { if (typeof (t = l({}, li, typeof t === 'object' && t ? t : {})).target !== 'string') { let e = p(t.target).attr('id'); e || (e = m.getUID(oi), p(t.target).attr('id', e)), t.target = `#${e}`; } return m.typeCheckConfig(oi, t, ci), t; }, t._getScrollTop = function () { return this._scrollElement === window ? this._scrollElement.pageYOffset : this._scrollElement.scrollTop; }, t._getScrollHeight = function () { return this._scrollElement.scrollHeight || Math.max(document.body.scrollHeight, document.documentElement.scrollHeight); }, t._getOffsetHeight = function () { return this._scrollElement === window ? window.innerHeight : this._scrollElement.getBoundingClientRect().height; }, t._process = function () { const t = this._getScrollTop() + this._config.offset; const e = this._getScrollHeight(); const n = this._config.offset + e - this._getOffsetHeight(); if (this._scrollHeight !== e && this.refresh(), n <= t) { const i = this._targets[this._targets.length - 1]; this._activeTarget !== i && this._activate(i); } else { if (this._activeTarget && t < this._offsets[0] && this._offsets[0] > 0) return this._activeTarget = null, void this._clear(); for (let o = this._offsets.length; o--;) { this._activeTarget !== this._targets[o] && t >= this._offsets[o] && (typeof this._offsets[o + 1] === 'undefined' || t < this._offsets[o + 1]) && this._activate(this._targets[o]); } } }, t._activate = function (e) { this._activeTarget = e, this._clear(); const t = this._selector.split(',').map((t) => `${t}[data-target="${e}"],${t}[href="${e}"]`); const n = p([].slice.call(document.querySelectorAll(t.join(',')))); n.hasClass(ui) ? (n.closest(vi).find(Ei).addClass(fi), n.addClass(fi)) : (n.addClass(fi), n.parents(pi).prev(`${mi}, ${_i}`).addClass(fi), n.parents(pi).prev(gi).children(mi).addClass(fi)), p(this._scrollElement).trigger(hi.ACTIVATE, { relatedTarget: e }); }, t._clear = function () { [].slice.call(document.querySelectorAll(this._selector)).filter((t) => t.classList.contains(fi)).forEach((t) => t.classList.remove(fi)); }, n._jQueryInterface = function (e) { return this.each(function () { let t = p(this).data(ri); if (t || (t = new n(this, typeof e === 'object' && e), p(this).data(ri, t)), typeof e === 'string') { if (typeof t[e] === 'undefined') throw new TypeError(`No method named "${e}"`); t[e](); } }); }, s(n, null, [{ key: 'VERSION', get() { return '4.3.1'; } }, { key: 'Default', get() { return li; } }]), n;
  }()); p(window).on(hi.LOAD_DATA_API, () => { for (let t = [].slice.call(document.querySelectorAll(di)), e = t.length; e--;) { const n = p(t[e]); Ci._jQueryInterface.call(n, n.data()); } }), p.fn[oi] = Ci._jQueryInterface, p.fn[oi].Constructor = Ci, p.fn[oi].noConflict = function () { return p.fn[oi] = ai, Ci._jQueryInterface; }; const Ti = 'bs.tab'; const Si = `.${Ti}`; const Di = p.fn.tab; const Ii = {
    HIDE: `hide${Si}`, HIDDEN: `hidden${Si}`, SHOW: `show${Si}`, SHOWN: `shown${Si}`, CLICK_DATA_API: `click${Si}.data-api`,
  }; const Ai = 'dropdown-menu'; const Oi = 'active'; const Ni = 'disabled'; const ki = 'fade'; const Li = 'show'; const xi = '.dropdown'; const Pi = '.nav, .list-group'; const Hi = '.active'; const ji = '> li > .active'; const Ri = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]'; const Fi = '.dropdown-toggle'; const Mi = '> .dropdown-menu .active'; const Wi = (function () { function i(t) { this._element = t; } const t = i.prototype; return t.show = function () { const n = this; if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Oi) || p(this._element).hasClass(Ni))) { let t; let i; const e = p(this._element).closest(Pi)[0]; const o = m.getSelectorFromElement(this._element); if (e) { const r = e.nodeName === 'UL' || e.nodeName === 'OL' ? ji : Hi; i = (i = p.makeArray(p(e).find(r)))[i.length - 1]; } const s = p.Event(Ii.HIDE, { relatedTarget: this._element }); const a = p.Event(Ii.SHOW, { relatedTarget: i }); if (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) { o && (t = document.querySelector(o)), this._activate(this._element, e); const l = function () { const t = p.Event(Ii.HIDDEN, { relatedTarget: n._element }); const e = p.Event(Ii.SHOWN, { relatedTarget: i }); p(i).trigger(t), p(n._element).trigger(e); }; t ? this._activate(t, t.parentNode, l) : l(); } } }, t.dispose = function () { p.removeData(this._element, Ti), this._element = null; }, t._activate = function (t, e, n) { const i = this; const o = (!e || e.nodeName !== 'UL' && e.nodeName !== 'OL' ? p(e).children(Hi) : p(e).find(ji))[0]; const r = n && o && p(o).hasClass(ki); const s = function () { return i._transitionComplete(t, o, n); }; if (o && r) { const a = m.getTransitionDurationFromElement(o); p(o).removeClass(Li).one(m.TRANSITION_END, s).emulateTransitionEnd(a); } else s(); }, t._transitionComplete = function (t, e, n) { if (e) { p(e).removeClass(Oi); const i = p(e.parentNode).find(Mi)[0]; i && p(i).removeClass(Oi), e.getAttribute('role') === 'tab' && e.setAttribute('aria-selected', !1); } if (p(t).addClass(Oi), t.getAttribute('role') === 'tab' && t.setAttribute('aria-selected', !0), m.reflow(t), t.classList.contains(ki) && t.classList.add(Li), t.parentNode && p(t.parentNode).hasClass(Ai)) { const o = p(t).closest(xi)[0]; if (o) { const r = [].slice.call(o.querySelectorAll(Fi)); p(r).addClass(Oi); }t.setAttribute('aria-expanded', !0); }n && n(); }, i._jQueryInterface = function (n) { return this.each(function () { const t = p(this); let e = t.data(Ti); if (e || (e = new i(this), t.data(Ti, e)), typeof n === 'string') { if (typeof e[n] === 'undefined') throw new TypeError(`No method named "${n}"`); e[n](); } }); }, s(i, null, [{ key: 'VERSION', get() { return '4.3.1'; } }]), i; }()); p(document).on(Ii.CLICK_DATA_API, Ri, function (t) { t.preventDefault(), Wi._jQueryInterface.call(p(this), 'show'); }), p.fn.tab = Wi._jQueryInterface, p.fn.tab.Constructor = Wi, p.fn.tab.noConflict = function () { return p.fn.tab = Di, Wi._jQueryInterface; }; const Ui = 'toast'; const Bi = 'bs.toast'; const qi = `.${Bi}`; const Ki = p.fn[Ui]; const Qi = {
    CLICK_DISMISS: `click.dismiss${qi}`, HIDE: `hide${qi}`, HIDDEN: `hidden${qi}`, SHOW: `show${qi}`, SHOWN: `shown${qi}`,
  }; const Vi = 'fade'; const Yi = 'hide'; const zi = 'show'; const Xi = 'showing'; const Gi = { animation: 'boolean', autohide: 'boolean', delay: 'number' }; const $i = { animation: !0, autohide: !0, delay: 500 }; const Ji = '[data-dismiss="toast"]'; const Zi = (function () { function i(t, e) { this._element = t, this._config = this._getConfig(e), this._timeout = null, this._setListeners(); } const t = i.prototype; return t.show = function () { const t = this; p(this._element).trigger(Qi.SHOW), this._config.animation && this._element.classList.add(Vi); const e = function () { t._element.classList.remove(Xi), t._element.classList.add(zi), p(t._element).trigger(Qi.SHOWN), t._config.autohide && t.hide(); }; if (this._element.classList.remove(Yi), this._element.classList.add(Xi), this._config.animation) { const n = m.getTransitionDurationFromElement(this._element); p(this._element).one(m.TRANSITION_END, e).emulateTransitionEnd(n); } else e(); }, t.hide = function (t) { const e = this; this._element.classList.contains(zi) && (p(this._element).trigger(Qi.HIDE), t ? this._close() : this._timeout = setTimeout(() => { e._close(); }, this._config.delay)); }, t.dispose = function () { clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(zi) && this._element.classList.remove(zi), p(this._element).off(Qi.CLICK_DISMISS), p.removeData(this._element, Bi), this._element = null, this._config = null; }, t._getConfig = function (t) { return t = l({}, $i, p(this._element).data(), typeof t === 'object' && t ? t : {}), m.typeCheckConfig(Ui, t, this.constructor.DefaultType), t; }, t._setListeners = function () { const t = this; p(this._element).on(Qi.CLICK_DISMISS, Ji, () => t.hide(!0)); }, t._close = function () { const t = this; const e = function () { t._element.classList.add(Yi), p(t._element).trigger(Qi.HIDDEN); }; if (this._element.classList.remove(zi), this._config.animation) { const n = m.getTransitionDurationFromElement(this._element); p(this._element).one(m.TRANSITION_END, e).emulateTransitionEnd(n); } else e(); }, i._jQueryInterface = function (n) { return this.each(function () { const t = p(this); let e = t.data(Bi); if (e || (e = new i(this, typeof n === 'object' && n), t.data(Bi, e)), typeof n === 'string') { if (typeof e[n] === 'undefined') throw new TypeError(`No method named "${n}"`); e[n](this); } }); }, s(i, null, [{ key: 'VERSION', get() { return '4.3.1'; } }, { key: 'DefaultType', get() { return Gi; } }, { key: 'Default', get() { return $i; } }]), i; }()); p.fn[Ui] = Zi._jQueryInterface, p.fn[Ui].Constructor = Zi, p.fn[Ui].noConflict = function () { return p.fn[Ui] = Ki, Zi._jQueryInterface; }, (function () { if (typeof p === 'undefined') throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript."); const t = p.fn.jquery.split(' ')[0].split('.'); if (t[0] < 2 && t[1] < 9 || t[0] === 1 && t[1] === 9 && t[2] < 1 || t[0] >= 4) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0"); }()), t.Util = m, t.Alert = g, t.Button = k, t.Carousel = at, t.Collapse = Ct, t.Dropdown = Xe, t.Modal = gn, t.Popover = ii, t.Scrollspy = Ci, t.Tab = Wi, t.Toast = Zi, t.Tooltip = qn, Object.defineProperty(t, '__esModule', { value: !0 });
}));
